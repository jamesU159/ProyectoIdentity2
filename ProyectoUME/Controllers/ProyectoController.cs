...
namespace ProyectoUME.Controllers
{
    public class ProyectoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProyecto,NumeroEmpleados,DireccionPoyecto,PersonaResponsable")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProyecto,NumeroEmpleados,DireccionPoyecto,PersonaResponsable")] Proyecto proyecto)
        {
